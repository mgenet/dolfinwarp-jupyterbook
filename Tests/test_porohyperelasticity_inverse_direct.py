...
load_lst  = []
load_lst += [["pgra", "pgra0"]]
load_lst += [["external", "external0"]]

print("load_lst", load_lst)
...
for loads in load_lst:
    ...
    U_tot_norm = (dolfin.assemble(dolfin.inner(U_tot, U_tot)*V)/2/dolfin.assemble(dolfin.Constant(1)*V))**(1/2)  
